    ...
    <main className="w-full px-6 md:px-12 max-w-7xl mx-auto py-44">
      ...
      <section className="text-center mb-20">
        ...
        <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
          Build fast, secure, and reliable payment experiences with our modern
          redirect API. ZentraPay provides a clean, simple, and scalable
          workflow for global payments.
        </p>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
        <DevFeature
          ...
          desc="Accept payments with a single API call and redirect flow."
        />
        <DevFeature
          title="Bank-Level Security"
          desc="Encryption, signed webhooks, and secure token validation."
        />
        <DevFeature
          title="Multi-Currency"
          desc="Support for crypto, fiat, wallets, and bank transfer."
        />
      </section>
      ...
      <section className="mb-20">
        ...
        <p className="text-gray-600 mb-6">
          Each request to ZentraPay requires your <strong>API Key</strong>.
...
ZENTRAPAY_SECRET_KEY=your_secret_key`}
      ...
      <section className="mb-20">
        ...
        <FlowStep number="5" title="NOWPayments processes the payment" />
        <FlowStep number="6" title="Webhook notifies ZentraPay backend" />
        <FlowStep number="7" title="ZentraPay updates your system" />
      </section>
...
window.location.href = data.invoice_url;`}
      ...
      <section className="mb-20">
        ...
        <CodeBlock>{`npm install zentrapay-sdk`}</CodeBlock>
...
console.log(payment.invoice_url);`}
      ...
      <section className="mb-20">
        ...
        <p className="text-gray-600 mt-2 mb-6">
          Webhooks notify your server when a payment succeeds, fails, or
          expires.
        </p>
  ...
  "message": "Invalid API key"
      ...
      <section className="mb-20">
        ...
        <p className="text-gray-600">
          You can make up to <strong>600 requests/minute</strong>.<br />
